...
class Program
    {
        ...
        // Takes in package weight, checks using ternary operator if weight is greater than 50.
        // If not greater than 50, proceeds to next step, getting the width. If greater, stops there.
        Console.WriteLine("Please enter the package's weight.");
        int packageWeight = Convert.ToInt32(Console.ReadLine());
        string weightCheck = packageWeight > 50 ? "Package too heavy to be shipped via Package Express. Have a good day." : "Please enter the package's width.";
